...
namespace HelloWorldUdemy.Views
{
    public partial class ContactBookDetailsPage : ContentPage
    {
        ...
        public event EventHandler<BookContact> ContactAdded;
        public event EventHandler<BookContact> ContactUpdated;


        public ContactBookDetailsPage(BookContact contact)
        {
            ...
            // updated.
            BindingContext = new BookContact
            {
                Id = contact.Id,
        ...
        {
            var contact = BindingContext as BookContact;
