...
namespace HelloWorldUdemy
{
    ...
    {
        private ObservableCollection<BookContact> _contacts;

        public ContactBookExercise()
        {
            InitializeComponent();

            _contacts = new ObservableCollection<BookContact>
            {
                new BookContact { Id = 1, FirstName = "John", LastName = "Smith", Email = "john@smith.com", Phone = "1111" },
                new BookContact { Id = 2, FirstName = "Mary", LastName = "Johnson", Email = "mary@johnson.com", Phone = "2222" }
            };
        ...
        {
            var page = new ContactBookDetailsPage(new BookContact());
        ...
        async void OnContactSelected(object sender, Xamarin.Forms.SelectedItemChangedEventArgs e)
        {
            ...
            var selectedContact = e.SelectedItem as BookContact;
            ...
            var page = new ContactBookDetailsPage(selectedContact);
        ...
        {
            var contact = (sender as MenuItem).CommandParameter as BookContact;
